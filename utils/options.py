...
def get_args():
    ...
    parser.add_argument("--lora_lr", type=float, default=0.00025)
    parser.add_argument("--bias_lr_factor", type=float, default=2.)

    parser.add_argument("--fine_tuning_factor", type=float, default=0.004)
    ...
    ######################## VPT setting ########################
    parser.add_argument("--vision_depth", type=int, default=12)
    parser.add_argument("--vision_ctx", type=int, default=4)
    parser.add_argument("--queue_size", type=int, default=1029)
    # parser.add_argument("--queue_size", type=int, default=65536)
    parser.add_argument("--momentum_factor", type=float, default=0.995)
    parser.add_argument("--alpha_label", type=float, default=0.4)
    ######################lora settings#####################
    parser.add_argument("--lora", default=True, action='store_true')
    parser.add_argument("--lora_FFN", default=True, action='store_true')
    parser.add_argument("--Wq_r", type=int, default=4)
    parser.add_argument("--Wk_r", type=int, default=4)
    parser.add_argument("--Wv_r", type=int, default=4)
    parser.add_argument("--lora_alpha", type=int, default=16)
    parser.add_argument("--pretrain_weight", default=True, action='store_true')
    parser.add_argument("--finetune", type=str, default="")
    parser.add_argument("--temp", type=float, default=0.05)
    parser.add_argument("--temp_instance", type=float, default=0.05)
    parser.add_argument("--momentum", type=float, default=0.1)
    parser.add_argument("--use_hard", default=False, action='store_true')
    parser.add_argument("--tau", type=float, default=0.02)
    parser.add_argument("--margin", type=float, default=0.2)
    parser.add_argument("--lamda1", type=float, default=0.5)
    parser.add_argument("--lamda2", type=float, default=0.5)
    parser.add_argument("--instance_momentum", type=float, default=0.1)
